    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="flex-1 flex flex-col items-center justify-center py-12 md:py-24 lg:py-32 px-4 text-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-100 via-slate-50 to-white">
        ...
        <div className="space-y-6 max-w-3xl animate-slide-up">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl text-slate-900">
            Welke <span className="text-teal-600">onderwijs-werkvorm</span><br /> past bij jou?
          </h1>
          ...
          <div className="flex flex-col gap-4 min-[400px]:flex-row justify-center pt-4">
            <Link href="/vragen">
              <Button size="lg" className="h-14 px-8 text-lg rounded-full shadow-xl shadow-teal-500/20 hover:shadow-teal-500/30 transition-all">
      ...
      <section className="container mx-auto py-12 md:py-20 px-4">
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="glass-panel border-teal-50 relative overflow-hidden group hover:border-teal-100 transition-colors">
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <UserCheck className="h-24 w-24 text-teal-600" />
            </div>
            <CardHeader>
              <UserCheck className="h-10 w-10 text-teal-600 mb-2" />
          ...
          <Card className="glass-panel border-teal-50 relative overflow-hidden group hover:border-teal-100 transition-colors">
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
              <ShieldCheck className="h-24 w-24 text-teal-600" />
            </div>
            <CardHeader>
